...
<section id="hero-fullscreen" class="hero-fullscreen d-flex align-items-center">
    <div class="container d-flex flex-column align-items-center position-relative" data-aos="zoom-out">
        <h2>Portal Lowongan Pekerjaan<span> Sumbar</span></h2>
        <p>Temukan Pekerjaan, Perusahaan & Peluang Karir Di Lingkungan Provinsi Sumatera Barat</p>
        <div class="d-flex search">
            {{-- <a href="https://www.youtube.com/watch?v=LXb3EKWsInQ" class="glightbox btn-watch-video d-flex align-items-center"><i class="bi bi-play-circle"></i><span>Watch Video</span></a> --}}
            <div>
                {{-- <form action="" method="post">
                    <input type="text" name="email" placeholder="Cari Lowongan Pekerjaan"><input type="submit" value="Cari">
                </form> --}}
                <div class="s003">
