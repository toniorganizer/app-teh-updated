...
<main id="main" class="main">
    ...
    <section class="section dashboard">
        <div class="row">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Table Laporan-IPK-III-6 | {{$nama->nama_lembaga}}</h5>
              <div class="activity overflow-scroll">
                <table class="table table-bordered center">
                    <tr><th rowspan="2">No</th><th rowspan="2">GOLONGAN USAHA & LAPANGAN USAHA</th><th colspan="2">Sisa Smtr Lalu</th><th colspan="2">Yang terdaftar Smtr ini</th><th colspan="2">Penempatan Smtr ini</th><th colspan="2">Dihapuskan Smtr ini</th><th colspan="2">Sisa Akhir Smtr ini</th><th rowspan="2">Action</th></tr> 
            ...
            <div class="col-lg-4">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                            <a href="/cetak-laporan-vi/{{$nama->email_lembaga}}" class="btn btn-info mt-0"><i class="bi bi-cloud-arrow-down"></i></a>
                            </div>
