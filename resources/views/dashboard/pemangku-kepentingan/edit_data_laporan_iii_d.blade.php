...
<main id="main" class="main">
    ...
    <section class="section dashboard">
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Edit data Laporan-IPK-III-4</h5>
              <div class="activity">
                ...
                <form id="search-form" action="/update-laporan-iv/{{$data->nmr}}" method="post" enctype="multipart/form-data">
                    @csrf
                <div class="row">
                    <h6>Jenis Pendidikan | {{$data->judul_lp}}</h6>
                    <div class="col-md-6">
                      <input type="hidden" value="{{$data->id_disnaker}}" name="id_disnaker" id="">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                              <input type="text" name="sisa_l" value="{{ $data->{'sisa_l_lp'} }}" class="form-control" id="inputEmail3">
                            </div>
                          </div>
                          <div class="form-group row">
                            <label for="inputEmail3" class="col-sm-7 col-form-label">Trdftar Smstr Ini (Laki-laki)</label>
                            <div class="col-sm-5">
                              <input type="text" name="terdaftar_l" value="{{ $data->{'terdaftar_l_lp'} }}" class="form-control" id="inputEmail3">
                            </div>
                          </div>
                          <div class="form-group row">
                            <label for="inputEmail3" class="col-sm-7 col-form-label">Penempatan Smstr Ini (Laki-laki)</label>
                            <div class="col-sm-5">
                              <input type="text" name="penempatan_l" value="{{ $data->{'penempatan_l_lp'} }}" class="form-control" id="inputEmail3">
                            </div>
                          </div>
                          <div class="form-group row">
                            <label for="inputEmail3" class="col-sm-7 col-form-label">Dihapuskan Smstr Ini (Laki-laki)</label>
                            <div class="col-sm-5">
                              <input type="text" name="hapus_l" value="{{ $data->{'hapus_l_lp'} }}" class="form-control" id="inputEmail3">
                            </div>
                          </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                              <input type="text" name="sisa_p" value="{{ $data->{'sisa_p_lp'} }}" class="form-control" id="inputEmail3">
                            </div>
                          </div>
                          <div class="form-group row">
                            <label for="inputEmail3" class="col-sm-7 col-form-label">Trdftar Smstr Ini (Perempuan)</label>
                            <div class="col-sm-5">
                              <input type="text" name="terdaftar_p" value="{{ $data->{'terdaftar_p_lp'} }}" class="form-control" id="inputEmail3">
                            </div>
                          </div>
                          <div class="form-group row">
                            <label for="inputEmail3" class="col-sm-7 col-form-label">Penempatan Smstr Ini (Perempuan)</label>
                            <div class="col-sm-5">
                              <input type="text" name="penempatan_p" value="{{ $data->{'penempatan_p_lp'} }}" class="form-control" id="inputEmail3">
                            </div>
                          </div>
                          <div class="form-group row">
                            <label for="inputEmail3" class="col-sm-7 col-form-label">Dihapuskan Smstr Ini (Perempuan)</label>
                            <div class="col-sm-5">
                              <input type="text" name="hapus_p" value="{{ $data->{'hapus_p_lp'} }}" class="form-control" id="inputEmail3">
                            </div>
                          </div>
                    </div>
