          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="activity">
                ...
                <p>Silahkan buat terlebih dahulu rentang tanggal terhadap laporan yang telah dibuat, kemudian pilih file laporan berdasarkan template yang sudah terisi data, selanjutnya pilih import.</p>
            ...
            <div class="col-lg-4">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                            <a href="{{Storage::url('public/file/test2.xlsx')}}" class="btn btn-primary mt-0"><i class="bi bi-cloud-arrow-down"></i></a>
                            </div>
                        </div>
                        ...
                        <h5 class="card-title mb-0">Pilih Laporan berdasarkan Kab. atau Kota</h5>
                        <div class="activity">
                            @foreach($kab as $data)
                            <div class="activity-item d-flex">
                              <i class='bi bi-circle-fill activity-badge text-success align-self-start'></i>
                              <div class="activity-content"><a href="#" class="fw-bold text-dark">{{$data->nama_lembaga}}</a>
                              </div>
