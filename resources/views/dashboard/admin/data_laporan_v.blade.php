                  ...
                  <div class="card-body pt-3">
                    ...
                    <div class="tab-content pt-2">
                      {{-- <div class="tab-pane fade show active profile-overview"> --}}
                        <h5 class="card-title">Table Laporan-IPK-III-V</h5>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="activity">
                ...
                <form id="search-form" action="/importIPKV" method="post" enctype="multipart/form-data">
                    @csrf
                <div class="row">
                    <div class="col-md-6">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            @if($aturan->status_lembaga == 1)
                            <div class="col-lg-3">
                                <a href="/delete-laporan-v/{{Auth::user()->email}}" class="btn btn-danger mt-0" onclick="return confirm('Anda yakin ingin menghapus data laporan IPK-III-5 ?')"><i class="bi bi-trash3"></i></a>
                            </div>
                            @endif
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                            <a href="/cetak-laporan-v/{{Auth::user()->email}}" class="btn btn-info mt-0"><i class="bi bi-cloud-arrow-down"></i></a>
                            </div>
