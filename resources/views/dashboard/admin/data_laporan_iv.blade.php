                  ...
                  <div class="card-body pt-3">
                    ...
                    <div class="tab-content pt-2">
                      {{-- <div class="tab-pane fade show active profile-overview"> --}}
                        <h5 class="card-title">LAPORAN-IPK-III-IV | LOWONGAN DIRINCI MENURUT PENDIDIKAN PROPINSI SUMATERA BARAT</h5>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="activity">
                ...
                <form id="search-form" action="/importIPKIV" method="post" enctype="multipart/form-data">
                    @csrf
                <div class="row">
                    <div class="col-md-6">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            @if($aturan->status_lembaga == 1)
                            <div class="col-lg-3">
                                <a href="/delete-laporan-iv/{{Auth::user()->email}}" class="btn btn-danger mt-0" onclick="return confirm('Anda yakin ingin menghapus data laporan IPK-III-4 ?')"><i class="bi bi-trash3"></i></a>
                            </div>
                            @endif
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                            <a href="/cetak-laporan-iv/{{Auth::user()->email}}" class="btn btn-info mt-0"><i class="bi bi-cloud-arrow-down"></i></a>
                            </div>
