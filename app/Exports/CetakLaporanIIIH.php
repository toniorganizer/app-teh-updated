...
class CetakLaporanIIIH implements WithDrawings, WithStyles, WithTitle, FromView, WithColumnWidths
{
    private $id;
    ...
    public function view(): View
    {
        ...
        ->selectRaw('CASE WHEN judul_kj = "TOTAL" THEN sisa_l_kj ELSE SUM(sisa_l_kj) END AS sisa_l_s')
        ->selectRaw('CASE WHEN judul_kj = "TOTAL" THEN sisa_p_kj ELSE SUM(sisa_p_kj) END AS sisa_p_s')
        ->selectRaw('CASE WHEN judul_kj = "TOTAL" THEN terdaftar_l_kj ELSE SUM(terdaftar_l_kj) END AS terdaftar_l_s')
        ->selectRaw('CASE WHEN judul_kj = "TOTAL" THEN terdaftar_p_kj ELSE SUM(terdaftar_p_kj) END AS terdaftar_p_s')
        ->selectRaw('CASE WHEN judul_kj = "TOTAL" THEN penempatan_l_kj ELSE SUM(penempatan_l_kj) END AS penempatan_l_s')
        ->selectRaw('CASE WHEN judul_kj = "TOTAL" THEN penempatan_p_kj ELSE SUM(penempatan_p_kj) END AS penempatan_p_s')
        ->selectRaw('CASE WHEN judul_kj = "TOTAL" THEN hapus_l_kj ELSE SUM(hapus_l_kj) END AS hapus_l_s')
        ->selectRaw('CASE WHEN judul_kj = "TOTAL" THEN hapus_p_kj ELSE SUM(hapus_p_kj) END AS hapus_p_s')
