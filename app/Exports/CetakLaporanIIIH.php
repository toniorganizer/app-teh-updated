...
class CetakLaporanIIIH implements WithDrawings, WithStyles, WithTitle, FromView, WithColumnWidths
{
    ...
    public function view(): View
    {
        ...
        ->selectRaw('CASE WHEN judul_kj = "TOTAL" THEN sisa_l_kj ELSE SUM(sisa_l_kj) END AS sisa_l')
        ->selectRaw('CASE WHEN judul_kj = "TOTAL" THEN sisa_p_kj ELSE SUM(sisa_p_kj) END AS sisa_p')
        ->selectRaw('CASE WHEN judul_kj = "TOTAL" THEN terdaftar_l_kj ELSE SUM(terdaftar_l_kj) END AS terdaftar_l')
        ->selectRaw('CASE WHEN judul_kj = "TOTAL" THEN terdaftar_p_kj ELSE SUM(terdaftar_p_kj) END AS terdaftar_p')
        ->selectRaw('CASE WHEN judul_kj = "TOTAL" THEN penempatan_l_kj ELSE SUM(penempatan_l_kj) END AS penempatan_l')
        ->selectRaw('CASE WHEN judul_kj = "TOTAL" THEN penempatan_p_kj ELSE SUM(penempatan_p_kj) END AS penempatan_p')
        ->selectRaw('CASE WHEN judul_kj = "TOTAL" THEN hapus_l_kj ELSE SUM(hapus_l_kj) END AS hapus_l')
        ->selectRaw('CASE WHEN judul_kj = "TOTAL" THEN hapus_p_kj ELSE SUM(hapus_p_kj) END AS hapus_p')
