...
class CetakLaporanVID implements WithDrawings, WithStyles, WithTitle, FromView, WithColumnWidths
{
    ...
    public function view(): View
    {
        ...
        ->where('id_disnaker', 'disnaker_dharmas@gmail.com')
        ...
        ->selectRaw('CASE WHEN judul_gu = "TOTAL" THEN sisa_l_gu ELSE SUM(sisa_l_gu) END AS sisa_l')
        ->selectRaw('CASE WHEN judul_gu = "TOTAL" THEN sisa_p_gu ELSE SUM(sisa_p_gu) END AS sisa_p')
        ->selectRaw('CASE WHEN judul_gu = "TOTAL" THEN terdaftar_l_gu ELSE SUM(terdaftar_l_gu) END AS terdaftar_l')
        ->selectRaw('CASE WHEN judul_gu = "TOTAL" THEN terdaftar_p_gu ELSE SUM(terdaftar_p_gu) END AS terdaftar_p')
        ->selectRaw('CASE WHEN judul_gu = "TOTAL" THEN penempatan_l_gu ELSE SUM(penempatan_l_gu) END AS penempatan_l')
        ->selectRaw('CASE WHEN judul_gu = "TOTAL" THEN penempatan_p_gu ELSE SUM(penempatan_p_gu) END AS penempatan_p')
        ->selectRaw('CASE WHEN judul_gu = "TOTAL" THEN hapus_l_gu ELSE SUM(hapus_l_gu) END AS hapus_l')
        ->selectRaw('CASE WHEN judul_gu = "TOTAL" THEN hapus_p_gu ELSE SUM(hapus_p_gu) END AS hapus_p')
